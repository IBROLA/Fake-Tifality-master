...
public class SoundManager
{
    ...
    public void playSoundFromFile(String fileName, double x, double y , double z) {
        SoundSystemConfig.setSoundFilesPackage("assets/minecraft/tifality/sounds/");
        ...
        sndSystem.setVolume("hitmarker", (float) (Tifality.getInstance().getModuleManager().getModule(Hitmarkers.class).volumeProperty.getValue() / 100));
