...
import club.tifality.module.impl.render.EnchantEffect;
...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private void renderEffect(IBakedModel model) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                int col = EnchantEffect.isGlintEnabled() ? EnchantEffect.getItemColor() : -8372020;
    ...
    public void renderItemOverlaysCR(FontRenderer p_175030_1_, ItemStack p_175030_2_, int p_175030_3_, int p_175030_4_) {
    ...
    public void renderItemOverlayIntoGUI(FontRenderer cr, ItemStack stack, float xPosition, float yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                String s = text == null ? String.valueOf(stack.stackSize) : text;
                ...
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                cr.drawString(s, (float) (xPosition + 19 - 2 - cr.getWidth(s)), (float) (yPosition + 6 + 3), 16777215, true);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
