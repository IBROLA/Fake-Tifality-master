...
import club.tifality.manager.event.impl.packet.PacketEvent;
...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) throws Exception {
        PacketEvent packetEvent = new PacketEvent(p_channelRead0_2_, PacketEvent.State.INCOMING);
        if (direction == EnumPacketDirection.CLIENTBOUND) Tifality.getInstance().getEventBus().post(packetEvent);
