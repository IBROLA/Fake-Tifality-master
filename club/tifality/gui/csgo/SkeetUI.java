...
public final class SkeetUI extends GuiScreen {
    ...
    private static final ResourceLocation BACKGROUND_IMAGE = new ResourceLocation("tifality/skeetchainmail.png");
    private static final char[] ICONS = {'E', 'F', 'J', 'C', 'I', 'H'};
    ...
    public static final Property<Integer> colorProperty = new Property<>("GUI Color", 10077246);
        ...
        for (ModuleCategory category : ModuleCategory.values()) {
            TabComponent categoryTab = new TabComponent(rootComponent,
                ...
                public void setupChildren() {
                    final List<Module> modulesInCategory = Tifality.getInstance().getModuleManager().getModulesForCategory(category);
