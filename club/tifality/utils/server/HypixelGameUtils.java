...
import club.tifality.manager.event.impl.world.ScoreboardModeChangeEvent;
...
public final class HypixelGameUtils {
    ...
    @Listener
    public void onModeChange(ScoreboardModeChangeEvent event) {
    ...
    @Listener
    public void onHeaderChange(ScoreboardHeaderChangeEvent event) {
